...
<head>
    ...
    <!-- Custom CSS -->
    <link href="<?php echo base_url(); ?>content/vendor/css/small-business.css" rel="stylesheet" type="text/css" />
    ...
    <!--[if lt IE 9]>
        ...
        PAGE : https://www.kickstarter.com/?ref=nav
        THEME : http://ironsummitmedia.github.io/startbootstrap-business-frontpage/
    <![endif]-->
    ...
    <nav class="navbar navbar-inverse navbar-fixed-top" role="navigation">
        <div class="container">
            ...
            <div class="navbar-header">
                ...
                <a class="navbar-brand" href="#">START KIOTECH</a>
            </div>
